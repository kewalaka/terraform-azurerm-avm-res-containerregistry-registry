...
This deploys the Container Registry module with cache rules for pulling upstream public container images (e.g., from Docker Hub and MCR) through the registry.

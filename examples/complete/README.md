...
This deploys the Container Registry module with all the possible settings
...
- [random_shuffle.regions_with_zones](https://registry.terraform.io/providers/hashicorp/random/latest/docs/resources/shuffle) (resource)
